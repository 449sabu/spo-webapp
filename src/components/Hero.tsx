    ...
    <>
      <div className="hero min-h-screen">
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center justify-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10 mx-3">
            <svg
              width="34.57"
              height="32"
              viewBox="0 0 256 237"
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center lg:max-w-2xl">
            ...
            <div className="flex justify-center">
              <a className=" btn inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg">
                Learn Cardano
              </a>
